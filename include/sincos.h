//
// Created by jin on 2023/9/8.
//

#ifndef CPP_ROBOTICS_SINCOS_H
#define CPP_ROBOTICS_SINCOS_H

#include <cstdio>

#define PI_OVER_2  1.57079632679
#define PI    3.14159265359
#define THREE_PI_OVER_2 4.71238898038
...
float cos ( float a ) {
    float a_sin = a + PI_OVER_2;
    a_sin = a_sin > TWO_PI ? a_sin - TWO_PI : a_sin;
    return sin ( a_sin );
}
